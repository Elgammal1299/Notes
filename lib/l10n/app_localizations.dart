...
class AppLocalizations {
  ...
  // App Bar
  String get appTitle =>
      locale.languageCode == 'ar' ? 'ملاحظات رائعة 📒' : 'Awesome Notes📒';
  String get newNote =>
      locale.languageCode == 'ar' ? 'ملاحظة جديدة' : 'New Note';
  String get editNote =>
      locale.languageCode == 'ar' ? 'تعديل الملاحظة' : 'Edit Note';
  ...
  // Note Editor
  String get titleHere =>
      locale.languageCode == 'ar' ? 'العنوان هنا' : 'Title here';
  String get noteHere =>
      locale.languageCode == 'ar' ? 'اكتب ملاحظتك هنا...' : 'Note here...';

  // Metadata
  String get lastModified =>
      locale.languageCode == 'ar' ? 'آخر تعديل' : 'Last Modified';
  String get created =>
      locale.languageCode == 'ar' ? 'تاريخ الإنشاء' : 'Created';
  ...
  String get noTagsAdded =>
      locale.languageCode == 'ar' ? 'لم تضف أي وسوم' : 'No tags added';
  ...
  String get dateModified =>
      locale.languageCode == 'ar' ? 'تاريخ التعديل' : 'Date Modified';
  String get dateCreated =>
      locale.languageCode == 'ar' ? 'تاريخ الإنشاء' : 'Date Created';
  ...
  String get setReminder =>
      locale.languageCode == 'ar' ? 'تعيين تذكير' : 'Set Reminder';
  String get removeReminder =>
      locale.languageCode == 'ar' ? 'إزالة التذكير' : 'Remove Reminder';
  String get reminderSet =>
      locale.languageCode == 'ar' ? 'تم تعيين التذكير' : 'Reminder Set';
  String get reminderRemoved =>
      locale.languageCode == 'ar' ? 'تم إزالة التذكير' : 'Reminder Removed';
  String get selectDateTime => locale.languageCode == 'ar'
      ? 'اختر التاريخ والوقت'
      : 'Select Date & Time';
  ...
  String get noReminderSet =>
      locale.languageCode == 'ar' ? 'لم يتم تعيين تذكير' : 'No reminder set';

  // To-Do List
  String get todos =>
      locale.languageCode == 'ar' ? 'قائمة المهام' : 'To-Do List';
  ...
  String get allCategories =>
      locale.languageCode == 'ar' ? 'كل الفئات' : 'All Categories';
  String get noTodosFound =>
      locale.languageCode == 'ar' ? 'لا توجد مهام!' : 'No to-dos found!';
  String get comingSoon =>
      locale.languageCode == 'ar' ? 'قريباً...' : 'Coming soon...';
  ...
  // Add/Edit To-Do
  String get newTodo =>
      locale.languageCode == 'ar' ? 'مهمة جديدة' : 'New To-Do';
  String get editTodo =>
      locale.languageCode == 'ar' ? 'تعديل المهمة' : 'Edit To-Do';
  String get todoTitle => locale.languageCode == 'ar' ? 'العنوان' : 'Title';
  String get todoTitleHint => locale.languageCode == 'ar'
      ? 'أدخل عنوان المهمة...'
      : 'Enter todo title...';
  String get todoDescription =>
      locale.languageCode == 'ar' ? 'الوصف' : 'Description';
  String get todoDescriptionHint => locale.languageCode == 'ar'
      ? 'أدخل وصف المهمة (اختياري)...'
      : 'Enter description (optional)...';
  String get deleteTodo =>
      locale.languageCode == 'ar' ? 'حذف المهمة' : 'Delete To-Do';
  String get deleteTodoConfirm => locale.languageCode == 'ar'
  ...
  String get mediumPriority =>
      locale.languageCode == 'ar' ? 'متوسطة' : 'Medium';
  ...
  // Dates
  String get dueDate =>
      locale.languageCode == 'ar' ? 'تاريخ الاستحقاق' : 'Due Date';
  String get selectDueDate =>
      locale.languageCode == 'ar' ? 'اختر تاريخ الاستحقاق' : 'Select due date';

  // Recurring
  String get recurringTask =>
      locale.languageCode == 'ar' ? 'مهمة متكررة' : 'Recurring Task';
  String get selectPattern =>
      locale.languageCode == 'ar' ? 'اختر النمط' : 'Select pattern';
  ...
  // Subtasks
  String get subtasks =>
      locale.languageCode == 'ar' ? 'المهام الفرعية' : 'Subtasks';
  String get addSubtask =>
      locale.languageCode == 'ar' ? 'أضف مهمة فرعية...' : 'Add a subtask...';

  // Settings
  String get settings => locale.languageCode == 'ar' ? 'الإعدادات' : 'Settings';
  String get theme => locale.languageCode == 'ar' ? 'المظهر' : 'Theme';
  String get lightMode => locale.languageCode == 'ar' ? 'فاتح' : 'Light Mode';
  String get darkMode => locale.languageCode == 'ar' ? 'داكن' : 'Dark Mode';
